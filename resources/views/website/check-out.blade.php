        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <textarea class="form-for-us" id="exampleFormControlTextarea1"></textarea>
                </div>
            </div>
            ...
            <div class="payment-marchant">
                ...
                <div class="personal">
                    ...
                    <button type="submit" class="button" name="apply_coupon" value="Apply coupon">Place Order</button>
                </div>
            </div>
        </div>
    </div>
