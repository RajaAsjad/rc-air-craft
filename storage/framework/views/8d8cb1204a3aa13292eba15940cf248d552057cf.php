				...
				<div class="box box-info">
					<div class="box-body">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                <input type="text" name="answer" id="" value="<?php echo e(old('answer')); ?>" class="form-control" placeholder="Enter answer">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                            <input type="text" name="choices[]" id="" value="<?php echo e(old('choices')); ?>" class="form-control" placeholder="Enter choices">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/demolinkweb2.com/public_html/rc-air-craft/resources/views/admin/product/create.blade.php ENDPATH**/ ?>