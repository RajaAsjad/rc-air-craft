                    ...
                    <div class="col-lg-4 col-md-6">
                        <ul class="products">
                            <li class="product aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                                <div class="pic">
                                    <img src="<?php echo e(asset('public/assets/website')); ?>/images/sold-out.jpg">
                                </div>
                                <div class="time-slot">
                                    <div id="countdown">
                                        <ul>
...
<?php echo $__env->make('layouts.website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/demolinkweb2.com/public_html/rc-air-craft/resources/views/website/sold-out.blade.php ENDPATH**/ ?>