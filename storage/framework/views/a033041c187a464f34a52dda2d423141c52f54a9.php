...
<input type="hidden" id="page_url" value="<?php echo e(route('how_to_play.index')); ?>">
<section class="content-header">
	<div class="content-header-left">
		<h1>All How to plays</h1>
	</div>
	<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('how_to_play-create')): ?>
	<div class="content-header-right">
		<a href="<?php echo e(route('how_to_play.create')); ?>" class="btn btn-primary btn-sm">Add How to play</a>
	</div>
	<?php endif; ?>
</section>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rc-air-craft\resources\views/admin/how_to_play/index.blade.php ENDPATH**/ ?>