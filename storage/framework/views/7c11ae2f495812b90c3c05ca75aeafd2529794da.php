                    ...
                    <div class="col-lg-4 col-md-6">
                        <ul class="products">
                            <li class="product aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                                <div class="pic">
                                    <img src="<?php echo e(asset('public/assets/website')); ?>/images/0c135afc-d363-4a73-99ba-554f9cf6c3fd-300x300.jpg">
                                </div>
                                <div class="time-slot">
                                    <div id="countdown">
                                        <ul>
                        ...
                        <ul class="products">
                            <li class="product aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div class="box">
                                    ...
                                    <p>HRB Lipo’s</p>
                                    <p>2 x 6s 4000mah or</p>
                                    <p>2 x 4s 5000mah or&nbsp;<strong></strong></p>
                                    <p>3 x 3s 5000 mah Lipos</p>
                                    <p></p>
                                </div>
                                <h5>0 <span>Entries Remaining</span></h5>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 play-inner">
                    <img src="<?php echo e(asset('public/assets/website')); ?>/images/play-1.png">
                ...
                <div class="col-lg-3 col-md-6 play-inner">
                    <img src="<?php echo e(asset('public/assets/website')); ?>/images/play-2.png">
                    <h4>answer the question</h4>
                    <p class="play-text">Answer the skill based question for your entry to be successful</p>
                </div>
                <div class="col-lg-3 col-md-6 play-inner">
                    <img src="<?php echo e(asset('public/assets/website')); ?>/images/play-4.png">
                ...
                <div class="col-lg-3 col-md-6 play-inner">
                    <img src="<?php echo e(asset('public/assets/website')); ?>/images/fb-1.png">
                    <h4>Facebook</h4>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <img src="<?php echo e(asset('public/assets/website')); ?>/images/20201206_231807.jpg" class="img-fluid">
                </div>
                    ...
                    <div class="slider-win" id="">
                        ...
                        <div class="testimonials-win">
                            <label class="item" id="myitem1" for="t-1">
                                <img src="<?php echo e(asset('public/assets/website')); ?>/images/gal-1.jpg">
                             </label>
                            <label class="item" id="myitem2" for="t-2">
                                <img src="<?php echo e(asset('public/assets/website')); ?>/images/gal-2.jpg">
                             </label>
                            <label class="item" id="myitem3" for="t-3">
                                <img src="<?php echo e(asset('public/assets/website')); ?>/images/gal-3.jpg">
                             </label>
                            <label class="item" id="myitem4" for="t-4">
                                <img src="<?php echo e(asset('public/assets/website')); ?>/images/gal-4.jpg">
                             </label>
                            <label class="item" id="myitem5" for="t-5">
                                <img src="<?php echo e(asset('public/assets/website')); ?>/images/gal-5.jpg">
                             </label>
                        </div>
                    </div>
