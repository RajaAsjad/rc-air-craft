                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="billing">
                                            ...
                                            <a href="<?php echo e(route ('billing-address')); ?>" class="edit">Edit</a>
                                            <a href="<?php echo e(route ('billing-address')); ?>" class="add">Add</a>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="billing">
                                            ...
                                            <a href="<?php echo e(route ('shipping-address')); ?>" class="edit">Edit</a>
                                            <a href="<?php echo e(route ('shipping-address')); ?>" class="add">Add</a>
...
<?php echo $__env->make('layouts.website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/demolinkweb2.com/public_html/rc-air-craft/resources/views/website/registration.blade.php ENDPATH**/ ?>